...
function redConverter() {
  ...
  //Tucan tiene 1280 pixeles por cada una de sus filas y 838 pixeles por columna
  for (let i = 0; i < pixels.length; i++) {
    //Por cada una de las filas se selecciona y opera sobre cada una de las columnas de la fila
    for (let j = 0; j < pixels[i].length; j++) {
      const rgb = pixels[i][j];
      rgb[1] = 0;
      rgb[2] = 0;
    }
  }
...
switch (optionN) {
  ...
  case 7: dimBrightness(2.5); break;
