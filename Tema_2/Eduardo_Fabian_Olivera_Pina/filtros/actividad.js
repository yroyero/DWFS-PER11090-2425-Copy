...
function redConverter() {
  ...
  for (let fila = 0; fila < pixels.length; fila++) {
    for (let pix = 0; pix < pixels[fila].length; pix++) {
      pixels[fila][pix][1] = 0; // canal G
      pixels[fila][pix][2] = 0; // canal B
    }
  }
...
function greyConverter() {
  ...
  for (let fila = 0; fila < pixels.length; fila++) {
    for (let pix = 0; pix < pixels[fila].length; pix++) {
      ...
      pixels[fila][pix][0] = media; // canal R
      pixels[fila][pix][1] = media; // canal G
      pixels[fila][pix][2] = media; // canal B
    }
  }
  handler.savePixels(pixels, outputPath);
}
