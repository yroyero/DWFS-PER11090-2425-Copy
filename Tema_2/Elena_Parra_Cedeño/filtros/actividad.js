...
function greyConverter() {
    ...
    for (let row = 0; row < pixels.length; row++) {
        for (let column = 0; column < pixels[row].length; column++) {
            let sum = 0
            for (let pixel = 0; pixel < pixels[row][column].length; pixel++) {
                sum += pixels[row][column][pixel];
            }
            let media = sum / pixels[row][column].length;
            pixels[row][column][0] = media;
            pixels[row][column][1] = media;
            pixels[row][column][2] = media;
        }
    }
...
function invertColors() {
    ...
    for (let row = 0; row < pixels.length; row++) {
        for (let column = 0; column < pixels[row].length; column++) {
            pixels[row][column][0] = valor - pixels[row][column][0];
            pixels[row][column][1] = valor - pixels[row][column][1];
            pixels[row][column][2] = valor - pixels[row][column][2];
        }
    }
    handler.savePixels(pixels, outputPath);
}
...
function merge(alphaFirst, alphaSecond) {
    ...
    for (let row = 0; row < catPixels.length; row++) {
        ...
        for (let column = 0; column < catPixels[row].length; column++) {
            let newColumn = []
            for (let pixel = 0; pixel < catPixels[row][column].length; pixel++) {
                catPixels[row][column][pixel] = catPixels[row][column][pixel] * alphaFirst;
                dogPixels[row][column][pixel] = dogPixels[row][column][pixel] * alphaSecond;
                newColumn.push(catPixels[row][column][pixel] + dogPixels[row][column][pixel]);
            }
