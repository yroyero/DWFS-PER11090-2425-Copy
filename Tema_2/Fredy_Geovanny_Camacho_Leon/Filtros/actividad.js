...
function greenConverter() {
    ...
    for (let fila = 0; fila < pixels.length; fila++) {
        for (let columna = 0; columna < pixels[fila].length; columna++) {
            pixels[fila][columna][0] = 0; // R = 0
            pixels[fila][columna][2] = 0; // B = 0
        }
    }
...
function greyConverter() {
    ...
    for (let fila = 0; fila < pixels.length; fila++) {
        for (let columna = 0; columna < pixels[fila].length; columna++) {
            let avg = (pixels[fila][columna][0] + pixels[fila][columna][1] + pixels[fila][columna][2]) / 3;
...
function blackAndWhiteConverter() {
    ...
    for (let fila = 0; fila < pixels.length; fila++) {
        for (let columna = 0; columna < pixels[fila].length; columna++) {
            ...
            pixels[fila][columna][0] = color;
            pixels[fila][columna][1] = color;
            pixels[fila][columna][2] = color;
        }
    }
...
function scaleDown() {
    ...
    // Guardar la imagen usando scaledPixels en lugar de pixels
    ...
    for (let i = 0; i < dogPixels.length; i++) {
        ...
        for (let j = 0; j < dogPixels[i].length; j++) {
            let mergedPixel = [
                ...
                dogPixels[i][j][1] * alphaFirst + catPixels[i][j][1] * alphaSecond,
                dogPixels[i][j][2] * alphaFirst + catPixels[i][j][2] * alphaSecond
            ];
