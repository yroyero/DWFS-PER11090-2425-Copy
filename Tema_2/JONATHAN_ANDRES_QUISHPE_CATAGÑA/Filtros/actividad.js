...
function merge(alphaFirst, alphaSecond) {
    ...
    for (let i = 0; i < catPixels.length; i++) {
        ...
        for (let j = 0; j < catPixels[i].length; j++) {
            ...
            let r = alphaFirst * dogPixel[0] + alphaSecond * catPixel[0];
            let g = alphaFirst * dogPixel[1] + alphaSecond * catPixel[1];
            let b = alphaFirst * dogPixel[2] + alphaSecond * catPixel[2];
