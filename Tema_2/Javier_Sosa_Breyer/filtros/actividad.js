...
function greyConverter() {
  ...
  for (let i = 0; i < rows; i++) {
    let columns = pixels[i].length;
    for (let j = 0; j < columns; j++) {
      let redValue = pixels[i][j][0];
      let greenValue = pixels[i][j][1];
      let blueValue = pixels[i][j][2];
...
function blackAndWhiteConverter() {
  ...
  for (let i = 0; i < rows; i++) {
    ...
    for (let j = 0; j < columns; j++) {
      ...
      pixels[i][j][0] = newValue;
      pixels[i][j][1] = newValue;
      pixels[i][j][2] = newValue;
    }
  }
...
function dimBrightness(dimFactor) {
  ...
  for (let i = 0; i < rows; i++) {
    ...
    for (let j = 0; j < columns; j++) {
      ...
      pixels[i][j][0] = redValue/dimFactor;
      pixels[i][j][1] = greenValue/dimFactor;
      pixels[i][j][2] = blueValue/dimFactor;
    }
  }
...
function invertColors() {
  ...
  for (let i = 0; i < rows; i++) {
    ...
    for (let j = 0; j < columns; j++) {
      ...
      pixels[i][j][0] = 255 - redValue;
      pixels[i][j][1] = 255 - greenValue;
      pixels[i][j][2] = 255 - blueValue;
    }
  }
