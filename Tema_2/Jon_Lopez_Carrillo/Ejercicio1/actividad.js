...
function scaleDown() {
    ...
    handler.savePixels(nuevaImagen,outputPath,nuevaImagen.length,nuevaImagen[0].length);
}
...
function merge(alphaFirst, alphaSecond) {
    ...
    for (let i = 0; i < catPixels.length; i++) {
        ...
        for (let j = 0; j < catPixels[0].length; j++) {
            ...
            let pixel = [
                catPixel[0] * alphaSecond + dogPixel[0] * alphaFirst,
                catPixel[1] * alphaSecond + dogPixel[1] * alphaFirst,
                catPixel[2] * alphaSecond + dogPixel[2] * alphaFirst,
            ];
            nuevaFila.push(pixel);
        }
        pixels.push(nuevaFila);
