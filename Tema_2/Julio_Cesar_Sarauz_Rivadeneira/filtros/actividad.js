...
function greyConverter() {
  ...
  for (let fila = 0; fila < pixels.length; fila++) {
    for (let columna = 0; columna < pixels[fila].length; columna++) {
      const gris = (pixels[fila][columna][0] +pixels[fila][columna][1] +pixels[fila][columna][2])/3;
      pixels[fila][columna][0] = gris;
      pixels[fila][columna][1] = gris;
      pixels[fila][columna][2] = gris;
    }
  }
  handler.savePixels(pixels, outputPath);
}
...
function blackAndWhiteConverter() {
  ...
  for (let fila = 0; fila < pixels.length; fila++) {
    for (let columna = 0; columna < pixels[fila].length; columna++) {
      ...
      if(gris >= umbral)
        BN = 255;
      pixels[fila][columna][0] = BN;
      pixels[fila][columna][1] = BN;
      pixels[fila][columna][2] = BN;
    }
  }
...
function scaleDown() {
  ...
  for (let fila = 0; fila < pixels.length; fila+=2) {
    for (let columna = 0; columna < pixels[fila].length; columna+=2) {            
      pixels[fila/2][columna/2][0] = pixels[fila][columna][0];
      pixels[fila/2][columna/2][1] = pixels[fila][columna][1];
      pixels[fila/2][columna/2][2] = pixels[fila][columna][2];
    }        
  }
...
function invertColors() {
  ...
  for (let fila = 0; fila < pixels.length; fila++) {
    for (let columna = 0; columna < pixels[fila].length; columna++) {            
      pixels[fila][columna][0] = inversor - pixels[fila][columna][0];
      pixels[fila][columna][1] = inversor - pixels[fila][columna][1];
      pixels[fila][columna][2] = inversor - pixels[fila][columna][2];
    }        
  }
  handler.savePixels(pixels, outputPath);
}
...
function merge(alphaFirst, alphaSecond) {
  ...
  for (let fila = 0; fila < catPixels.length; fila++) {
    for (let columna = 0; columna < catPixels[fila].length; columna++) {            
      pixels[fila][columna][0] = dogPixels[fila][columna][0]* alphaFirst + catPixels[fila][columna][0]* alphaSecond;
      pixels[fila][columna][1] = dogPixels[fila][columna][0]* alphaFirst + catPixels[fila][columna][1]* alphaSecond;
      pixels[fila][columna][2] = dogPixels[fila][columna][0]* alphaFirst + catPixels[fila][columna][2]* alphaSecond;
    }        
  }
