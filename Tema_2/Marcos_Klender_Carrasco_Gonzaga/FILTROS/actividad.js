...
function scaleDown() {
  ...
  //Aqui tu codigo
  pixels = pixels.filter((fila, index) => index % 2 === 0).map(fila => fila.filter((columna, index) => index % 2 === 0));
...
function merge(alphaFirst, alphaSecond) {
  ...
  for(let fila = 0; fila < catPixels.length; fila++) {
    ...
    for(let columna = 0; columna < catPixels[fila].length; columna++) {
      let pixel = [];
      pixel[0] = catPixels[fila][columna][0] * alphaFirst + dogPixels[fila][columna][0] * alphaSecond;
      pixel[1] = catPixels[fila][columna][1] * alphaFirst + dogPixels[fila][columna][1] * alphaSecond;
      pixel[2] = catPixels[fila][columna][2] * alphaFirst + dogPixels[fila][columna][2] * alphaSecond;
      nuevaFila.push(pixel);
    }
