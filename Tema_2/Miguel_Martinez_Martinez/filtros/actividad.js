...
function greyConverter() {
  ...
  let rows = pixels.length;
    ...
    for (let r = 0; r < rows; r++) {
        let columns = pixels[r].length;
        for (let c = 0; c < columns; c++) {
            let average = (pixels[r][c][0] + pixels[r][c][1] + pixels[r][c][2]) / 3;
            pixels[r][c][0] = average;
            pixels[r][c][1] = average;
            pixels[r][c][2] = average;
        }
    }
...
function dimBrightness(dimFactor) {
  ...
  let rows = pixels.length;
    ...
    for (let r = 0; r < rows; r++) {
        let columns = pixels[r].length;
        for (let c = 0; c < columns; c++) {
            pixels[r][c][0] /= dimFactor;
            pixels[r][c][1] /= dimFactor;
            pixels[r][c][2] /= dimFactor;
        }
    }
...
function invertColors() {
  ...
  let rows = pixels.length;
    ...
    for (let r = 0; r < rows; r++) {
        let columns = pixels[r].length;
        for (let c = 0; c < columns; c++) {
            pixels[r][c][0] = 255 - pixels[r][c][0];
            pixels[r][c][1] = 255 - pixels[r][c][1];
            pixels[r][c][2] = 255 - pixels[r][c][2];
        }
    }
...
function merge(alphaFirst, alphaSecond) {
  ...
  for (let r = 0; r < pixels.length; r++) {
      let columns = pixels[r].length;
      for (let c = 0; c < columns; c++) {
        pixels[r][c][0] = catPixels[r][c][0] * alphaFirst + dogPixels[r][c][0] * alphaSecond;
        pixels[r][c][1] = catPixels[r][c][1] * alphaFirst + dogPixels[r][c][1] * alphaSecond;
        pixels[r][c][2] = catPixels[r][c][2] * alphaFirst + dogPixels[r][c][2] * alphaSecond;
      }
  }
