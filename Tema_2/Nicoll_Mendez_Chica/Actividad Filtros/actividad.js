...
function greyConverter() {
  ...
  for (let fila=0; fila < pixels.length ; fila++){
    for(let columna=0 ; columna < pixels[fila].length ; columna++){
      let media=0;
      media = (pixels[fila][columna][0]+pixels[fila][columna][1]+pixels[fila][columna][2])/3;
...
function merge(alphaFirst, alphaSecond) {
  ...
  //Aqui tu codigo
  for (let fila = 0; fila < dogPixels.length; fila ++) {
    NuevaFila = [];
    for (let columna = 0; columna < dogPixels[fila].length; columna ++) {
      let mergedPixels = [
        dogPixels[fila][columna][0] * alphaFirst + catPixels[fila][columna][0] * alphaSecond,
        dogPixels[fila][columna][1] * alphaFirst + catPixels[fila][columna][1] * alphaSecond,
        dogPixels[fila][columna][2] * alphaFirst + catPixels[fila][columna][2] * alphaSecond
      ];
      NuevaFila.push(mergedPixels);
    }
