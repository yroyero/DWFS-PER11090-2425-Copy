...
function redConverter() {
    let outputPath = 'output/cat_red.jpg';
...
function greenConverter() {
    let outputPath = 'output/cat_green.jpg';
    let pixels = handler.getPixels();
...
function blueConverter() {
    let outputPath = 'output/cat_blue.jpg';
    let pixels = handler.getPixels();
...
function greyConverter() {
    let outputPath = 'output/cat_grey.jpg';
    let pixels = handler.getPixels();
...
function blackAndWhiteConverter() {
    let outputPath = 'output/cat_black_and_white.jpg';
    let pixels = handler.getPixels();
    ...
    for (let fila = 0; fila < pixels.length; fila++) {
        for (let columna = 0; columna < pixels[fila].length; columna++) {
            ...
            let g = pixels[fila][columna][1];
            let b = pixels[fila][columna][2];
            let promedioBW = Math.round((r + g + b) / 3);
            ...
            pixels[fila][columna][0] = promedioBW;
            pixels[fila][columna][1] = promedioBW;
            pixels[fila][columna][2] = promedioBW;
        }
    }
...
function dimBrightness(dimFactor) {
    let outputPath = 'output/cat_dimed.jpg';
    let pixels = handler.getPixels();
...
function invertColors() {
    let outputPath = 'output/cat_inverse.jpg';
    let pixels = handler.getPixels();
