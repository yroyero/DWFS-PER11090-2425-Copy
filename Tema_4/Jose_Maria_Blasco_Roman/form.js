...
document.getElementById('userForm').addEventListener('submit', (event) => {
    ...
    if (errorMessages.length === 0) {
        // No hay errores, se puede procesar el formulario *****MODIFICAMOS AQUÍ**** usamos el window.location.replace Evita que el usuario vuelva a la página del formulario usando el botón "Atrás".
