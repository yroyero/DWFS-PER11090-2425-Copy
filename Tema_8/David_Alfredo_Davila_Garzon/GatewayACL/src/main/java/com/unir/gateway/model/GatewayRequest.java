...
/**
 * This class represents a request that is being processed by the gateway. It contains information about the target HTTP method, query parameters,
 * body, exchange, and headers of the request.
 */
@Getter
@Setter
@AllArgsConstructor
